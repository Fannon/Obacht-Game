...
white_lines_demo.start = function() {
    ...
    var circle1 = new lime.Sprite().setSize(800, 800).setFill('landscapeB.png').setPosition((VIEWPORT_WIDTH / 2), (VIEWPORT_HEIGHT / 2)).setAnchorPoint(0.5, 0.5).setRenderer(lime.Renderer.CANVAS);
    var circle2 = new lime.Sprite().setSize(800, 800).setFill('landscapeB.png').setPosition((VIEWPORT_WIDTH / 2) + 200, (VIEWPORT_HEIGHT / 2) + 200).setAnchorPoint(0.5, 0.5).setRenderer(lime.Renderer.CANVAS);
