...
prototype_claudia.start = function(){
	...
	var director = new lime.Director(document.body, VIEWPORT_WIDTH, VIEWPORT_HEIGHT),
        ...
        background = new lime.Sprite().setSize(VIEWPORT_WIDTH,VIEWPORT_HEIGHT).setFill('images/wiese/Verlauf_Wiese.jpg').setPosition(0,0).setAnchorPoint(0,0),
        himmel1 = new lime.Sprite().setSize(1750,1750).setFill('images/wiese/Himmel_Wiese.png').setPosition(0,1960).setAnchorPoint(0,1),
        himmel2 = new lime.Sprite().setSize(1750,1750).setFill('images/wiese/Himmel_Wiese.png').setPosition(0,1960).setAnchorPoint(0,1).setRotation(90),
        landschaftHinten1 = new lime.Sprite().setSize(1680,1680).setFill('images/wiese/Landschaft2_Wiese.png').setPosition(0,1960).setAnchorPoint(0,1),
        landschaftHinten2 = new lime.Sprite().setSize(1680,1680).setFill('images/wiese/Landschaft2_Wiese.png').setPosition(0,1960).setAnchorPoint(0,1).setRotation(90),
        landschaftVorne1 = new lime.Sprite().setSize(1590,1590).setFill('images/wiese/Landschaft1_Wiese.png').setPosition(0,1960).setAnchorPoint(0,1),
        landschaftVorne2 = new lime.Sprite().setSize(1590,1590).setFill('images/wiese/Landschaft1_Wiese.png').setPosition(0,1960).setAnchorPoint(0,1).setRotation(90),
        erde1 = new lime.Sprite().setSize(1470,1470).setFill('images/wiese/Erde_Wiese.png').setPosition(0,1960).setAnchorPoint(0,1),
        erde2 = new lime.Sprite().setSize(1470,1470).setFill('images/wiese/Erde_Wiese.png').setPosition(0,1960).setAnchorPoint(0,1).setRotation(90),
