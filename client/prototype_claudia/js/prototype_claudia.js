...
prototype_claudia.start = function(){
	...
	var director = new lime.Director(document.body, VIEWPORT_WIDTH, VIEWPORT_HEIGHT),
        ...
        erde = new lime.Sprite().setSize(1470,1470).setFill('images/wiese/Erde_Wiese.png').setPosition(0,1960).setAnchorPoint(0,1),
        landschaft1 = new lime.Sprite().setSize(1590,1590).setFill('images/wiese/Landschaft1_Wiese.png').setPosition(0,1960).setAnchorPoint(0,1),
        landschaft2 = new lime.Sprite().setSize(1680,1680).setFill('images/wiese/Landschaft2_Wiese.png').setPosition(0,1960).setAnchorPoint(0,1),
        himmel = new lime.Sprite().setSize(1750,1750).setFill('images/wiese/Himmel_Wiese.png').setPosition(0,1960).setAnchorPoint(0,1),
